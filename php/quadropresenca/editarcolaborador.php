...
<body>
    ...
    <form method="POST" action="peditarcolaborador.php">
        <input type="hidden" name="id" value="<?php echo $linha_colaborador ['id']; ?>" required>
        <label>Colaborador: </label><br>
        <input type="text" name="colaborador" placeholder="Edite o nome do colaborador" value="<?php echo $linha_colaborador ['colaborador']; ?>" required><br><br>
        <label>Posto de Trabalho:</label><br>
        <input type="text" name="posto_de_trabalho" placeholder="Edite o posto de trabalho deste colaborador" value="<?php echo $linha_colaborador ['posto_de_trabalho']; ?>" required><br><br>
